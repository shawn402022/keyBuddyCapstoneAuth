...
Revision ID: cb1d28356eee
Revises: 
Create Date: 2025-01-15 06:40:27.134676
...
def upgrade():
    ...
    sa.Column('pulls_from', sa.String(length=40), nullable=True),
    ...
    sa.Column('course_reviewed', sa.String(length=500), nullable=True),
