...
export declare type KeyEventHandler = (note: INoteValue) => void;
export declare class PianoElement {
    ...
    constructor(container: G, instrumentSettings: InstrumentSettings, onKeyPress: KeyEventHandler, onKeyRelease: KeyEventHandler);
    get boxWidth(): number;
