...
//const flatNotes = Tonal.Range.chromatic(['C2, B7'],).filter((note)=> note.length > 2)
//const tNote = Tonal.Note
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    console.log(sharpNotes)
    //note('c4')
    const keyImages = new KeyImages()
    const utils = new Utilities()
    //const keyImageNatural = keyImages.releasedNatural
